...
with open(r'../27138/files_27138/27A_27138.txt') as file:
...
with open(r'../27138/files_27138/27B_27138.txt') as file:
    dots = [list(map(float, i.replace(',', '.').split())) for i in file]
...
# print(abs(max(clusters[2], key=lambda x: x[0])[0] * 10000))

max_x = -10 ** 10

for i in clusters[2]:
    max_x = max(max_x, i[0])
print(abs(max_x) * 10000)
...
print(abs(sum(max(dists)[1])) * 10000)
